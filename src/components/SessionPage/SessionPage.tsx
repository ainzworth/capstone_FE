  ...
  return(
    <tr key={1}>
              ...
              <td className="">
                {/* <Link
                  to={{
                    pathname: username.includes("admin")
                      ? "/admin"
                      : "/operator",
                ...
                >
                  ...
                  <button style={{minWidth: "80px"}} className="bg-[#6EC7DF] hover:bg-[#2691b4] text-white py-1.5 px-3 rounded-lg">
                    Scan
                  </button>
              </td>
              <td className="">
                      ...
                      <div className="flex flex-row justify-between items-center">
                        <div className="mt-[25px] flex justify-end">
                          <Dialog.Close asChild>
                            <button style={{minWidth: "100px"}} className="bg-[#d03940] text-black inline-flex h-[35px] items-center justify-center rounded-[4px] px-[15px] font-medium leading-none focus:outline-none">
                              No
                            </button>
                          </Dialog.Close>
                        </div>
      ...
      <table className=" mx-auto border-collapse sessionTable">
        ...
        <tbody>
          ...
          {sessions.map((session, index) => (
            <tr key={index}>
              <td className="border-4 border-black pl-7">{index + 1}</td>
              <td className="border-4 border-black p-5">{session.name}</td>
              <td className="border-4 border-black p-5">
                <Link
                  to={{
                    pathname: username.includes("admin")
                      ? "/admin"
                ...
                >
                  <button style={{color:"white",minWidth: "300px"}} className="bg-[#6EC7DF] hover:bg-[#2691b4] text-white py-2 px-4 rounded-lg">
                    Scan
                  </button>
                </Link>
              </td>
